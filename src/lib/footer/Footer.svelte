<script>
	import BottomAbout from './BottomAbout.svelte';
...
<footer
	class=" w-full h-[65.4rem] bg-darkGray md:h-[40rem] lg:h-[36.5rem] flex items-center
	justify-center px-[2.4rem] md:px-[4rem] lg:px-[16.5rem] xl:px-0 ">

	<div
		class="w-full h-full max-w-[111rem] footer-inner-container flex flex-col items-center
		justify-start relative pt-[5.2rem] gap-y-[4.8rem] md:items-start lg:flex-row lg:flex-wrap
		lg:justify-between lg:gap-y-0">

		<div
			class="accent-bar absolute top-0 h-[4px] w-[10.1rem] bg-darkOrange left-2/4 transform
			-translate-x-2/4 md:translate-x-0 md:left-0 transition-all " />

		<a href="/" class=" h-[2.5rem] w-[14.3rem] group lg:w-6/12">
		...
		<nav class="">
			<ul class=" flex flex-col items-center gap-y-[1.6rem] md:flex-row md:gap-x-[1.6rem]">
				{#each pages as { name, link }}
					<li
		...
		<p class="text-[1.5rem] font-extralight leading-[2.5rem] text-white opacity-50 lg:w-[54rem]">
		...
		<div
			class="w-full copyright-social-media-container flex flex-col items-center justify-center
			gap-y-[4.8rem] md:flex-row md:justify-between">

			<p class=" text-[1.5rem] font-bold leading-[2.5rem] text-white opacity-50 ">
				Copyright 2021. All Rights Reserved
			</p>

			<ul class="flex flex-row justify-center items-center gap-x-[1.6rem] ">
				{#each socialLinks as link}
					<li>
						<a href="https://www.{link}.com/" class="group">
							...
							{#if link === 'facebook'}
								<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
									<path
										...
										fill="#FFF"
										fill-rule="nonzero"
										class="group-hover:fill-current text-darkOrange transform
							...
							{:else}
								<svg width="24" height="24" xmlns="http://www.w3.org/2000/svg">
									<path
										...
										1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073
										7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98
