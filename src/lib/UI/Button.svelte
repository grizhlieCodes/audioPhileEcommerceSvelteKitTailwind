...
{:else if btnType === 'secondary'}
	<button
		class="text-[1.3rem] font-bold uppercase bg-white px-[3.4rem] py-[1.5rem] 
		hover:bg-black hover:text-white text-black tracking-[1px] border-[1px] border-black
		transition-all">
		{content}
	</button>
{:else if btnType === 'minimal'}
	<button
		class="text-[1.3rem] font-bold uppercase hover:text-darkOrange text-black tracking-[1px]
		transition-all flex flex-row justify-center items-center h-[48px] group">
