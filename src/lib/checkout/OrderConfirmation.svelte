...
<div
	...
	<h2 class=" text-[1.8rem] font-bold tracking-[1.29px] text-black uppercase w-full text-center ">
		confirm order
	</h2>
	<div id="items-list" class="top w-full min-h-52 flex flex-col flex-1 gap-y-[2.4rem] ">
	...
	<div class="text-container">
		<h2
			class=" text-[1.5rem] md:text-[1.8rem] leading-[2.5rem] text-black opacity-50 font-bold
			mb-[0.8rem] ">
			To be delivered to {$userStore.name}
		</h2>
		<p class=" text-[1.5rem] leading-[2.5rem] text-black opacity-50 text-left ">
			{$userStore.address}
		</p>
		<p class=" text-[1.5rem] leading-[2.5rem] text-black opacity-50 text-left ">
			{$userStore.city}
