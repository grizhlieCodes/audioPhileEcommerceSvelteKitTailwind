...
const products = writable([
    ...
    {
        displayName: "xx59 headphones",
        productSlug: "xx59-headphones",
        productCode: 'xx59',
        shortName: 'xx59',
        newProduct: false,
        productType: "headphones",
        topDescription: "Enjoy your audio almost anywhere and customize it to your specific tastes with the XX59 headphones. The stylish yet durable versatile wireless headset is a brilliant companion at home or on the move.",
        price: 1750,
        features: [
    ...
    },
    {
        ...
        topDescription: "Upgrade your sound system with the all new ZX9 active speaker. It’s a bookshelf speaker system that offers truly wireless connectivity -- creating new possibilities for more pleasing and practical audio setups.",
        price: 4500,
        features: [
    ...
    },
    {
        ...
        newProduct: false,
        productType: "speakers",
        topDescription: "Stream high quality sound wirelessly with minimal to no loss. The ZX7 speaker uses high-end audiophile components that represents the top of the line powered speakers for home or studio use.",
        price: 3500,
        features: [
    ...
    {
        displayName: "yx1 wireless earphones",
        productSlug: "yx1-wireless-earphones",
        productCode: 'yx1-earphones',
        shortName: 'yx1',
        newProduct: true,
        productType: "earphones",
        topDescription: "Tailor your listening experience with bespoke dynamic drivers from the new YX1 Wireless Earphones. Enjoy incredible high-fidelity sound even in noisy environments with its active noise cancellation feature.",
        price: 599,
        features: [
